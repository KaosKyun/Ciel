...
CIEL_VERSION="6.10.1" # x-release-please-version
  ...
  case "$name" in
    opencode)
      ...
      if $CURL_MODE; then
        ...
        for cmd in ciel-init ciel-update ciel-refresh ciel-improve ciel-eval ciel-create-skill ciel-audit ciel-memory-bootstrap ciel-migrate ciel-status; do
