---
description: "Long-running meta-agent for Ciel self-improvement. Dispatch on /ciel-improve, /ciel-eval, /ciel-create-skill. Analyzes sessions, proposes skill patch-sets for approval."
mode: subagent
