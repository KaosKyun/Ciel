---
name: relire-critic
description: How to self-review code effectively — hostile critique methodology, risk taxonomy, and quality checklist. Generates exactly 4 targeted critiques (functional, import/API, data assumption, security/state) then resolves each. Applicable after any code change.
